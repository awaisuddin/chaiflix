        ...
        if "videos" in str(link.get('href')):
            ...
            for links in soups.find_all('iframe'):
                ...
                for nm in soups.find_all('h1'):
                    ...
                    name = str(nm.get_text()).upper().replace("|","").replace("<","").replace(">","").replace("?","").replace("!","").replace("@","").replace("#","").replace("$","").replace("%","").replace("^","").replace("&","").replace("*","").replace("(","").replace(")","").replace(":","").replace("'","").replace(",","").replace(".","").replace("/","").replace("}","").replace("{","")                                                                                          
            ...
            try:
                ...
                myFile = open(str(counter)+'.html', 'w')
